    ...
    <div id="addClientModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="/bereket/new_contract_prestari_servicii" style="display: block;">
                    {{csrf_field()}}
    ...
    <table id="crud_table" class="table table-striped table-bordered" width="100%" cellspacing="0">
        ...
        @foreach($contracts as $contract)
            ...
            <tr>
                ...
                <form id="deleteForm{{$contract['id']}}" action="/bereket/delete_contract_prestari_servicii" method="post">
                    {{csrf_field()}}
                ...
                <div id="Modal{{$contract['id']}}" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" method="post" action="/bereket/update_contract_prestari_servicii" style="display: block;">
                                <div class="modal-body">
                                    {{csrf_field()}}
