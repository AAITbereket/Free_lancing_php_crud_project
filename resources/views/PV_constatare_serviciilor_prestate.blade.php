    ...
    <div id="addClientModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="/bereket/new_PV_constrate" style="display: block;">
                    {{csrf_field()}}
    ...
    <table id="crud_table" class="table table-striped table-bordered" width="100%" cellspacing="0">
        ...
        @foreach($PVprestates as $PVprestate)
            <tr>
                ...
                <form id="deleteForm{{$PVprestate['id']}}" action="/bereket/delete_PV_constrate" method="post">
                    {{csrf_field()}}
                ...
                <th>
                    ...
                    <a href="{{ url('/bereket/delete_PV_constrate') }}"
                       onclick="event.preventDefault();
                ...
                <div id="Modal{{$PVprestate['id']}}" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" method="post" action="/bereket/update_PV_constrate" style="display: block;">
                                <div class="modal-body">
                                    {{csrf_field()}}
