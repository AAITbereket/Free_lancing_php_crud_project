    ...
    <div id="addClientModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="/bereket/new_Adrese" style="display: block;">
                    {{csrf_field()}}
    ...
    <table id="crud_table" class="table table-striped table-bordered" width="100%" cellspacing="0">
        ...
        @foreach($addreses as $addrese)
            <tr>
                ...
                <form id="deleteForm{{$addrese['id']}}" action="/bereket/delete_Adrese" method="post">
                    {{csrf_field()}}
                ...
                <div id="Modal{{$addrese['id']}}" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" method="post" action="/bereket/update_Adrese" style="display: block;">
                                <div class="modal-body">
                                    {{csrf_field()}}
